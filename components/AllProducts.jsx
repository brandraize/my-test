...
export default function AllProducts({ lang, projects }) {
  ...
  }, [selectedCategories, projects, setcurrentPageIndex]);
  ...
  return (
    <div className="container my-5">
      <div className="d-flex justify-content-center mb-5">
        ...
        <form className="w-sm-75 position-relative" onSubmit={searchProjects}>
          <input
            type="search"
